...
export default function SaladGrid({ className }: GridGalleryProps) {
  // Direct import of images - adjust these paths to match your project structure
  const images = [
    { src: "/salad1.webp", alt: "The best Chicken Salad in addis ababa" },
    { src: "/salad2.webp", alt: "The best Side Salad in addis ababa" },
    { src: "/salad3.webp", alt: "The best Tuna Salad in addis ababa" },
    { src: "/salad4.webp", alt: "The best Jungle Salad in addis ababa" },
    { src: "/salad5.webp", alt: "The best salad in addis ababa" },
    { src: "/salad6.webp", alt: "The best salad in addis ababa" },
    { src: "/salad7.webp", alt: "The best salad in addis ababa" },
    { src: "/salad8.webp", alt: "The best salad in addis ababa" },
  ];
