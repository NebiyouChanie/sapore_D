...
export default function GridGallery({ className }: GridGalleryProps) {
  ...
  const images = [
    { src: "/gallarey1.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey2.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey3.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey4.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/burger6.webp", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey6.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey7.jpg", alt: "the best italian restaurant in addis ababa" },
    { src: "/gallarey8.jpg", alt: "the best italian restaurant in addis ababa" },
  ];
