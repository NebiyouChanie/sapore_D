...
export default function TraditionalGrid({ className }: GridGalleryProps) {
  // Direct import of images - adjust these paths to match your project structure
  const images = [
    { src: "/combo1.webp", alt: "The best Steak Combo in addis ababa" },
    { src: "/combo2.webp", alt: "The best Grilled Fish Combo in addis ababa" },
    { src: "/combo3.webp", alt: "The best Cutlet Combo  in addis ababa" },
    { src: "/combo4.webp", alt: "The best Grilled Chicken Combo in addis ababa" },
    { src: "/combo5.webp", alt: "The best combo in addis ababa" },
    { src: "/combo6.webp", alt: "The best combo in addis ababa" },
    { src: "/combo7.webp", alt: "The best combo in addis ababa" },
    { src: "/combo8.webp", alt: "The best combo in addis ababa" },
  ];
