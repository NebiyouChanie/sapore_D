...
export default function GalleryGrid1({ className }: GridGalleryProps) {
  // Direct import of images - adjust these paths to match your project structure
  const images = [
    { src: "/location1.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location2.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location3.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location4.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location5.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location6.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/location.jpg", alt: "the best italian restaurant in addis ababa " },
    { src: "/place1.jpg", alt: "the best italian restaurant in addis ababa " },
  ];
