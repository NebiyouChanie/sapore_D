...
export default function LasagnaGrid ({ className }: GridGalleryProps) {
   const images = [
    { src: "/lasagna1.webp", alt: "The best lasagna in addis ababa" },
    { src: "/lasagna2.webp", alt: "The best Fish Lasagna in addis ababa" },
    { src: "/lasagna3.webp", alt: "The best Lasagna Verde in addis ababa" },
    { src: "/lasagna4.webp", alt: "The best Beef Lasagna in addis ababa" },
    { src: "/lasagna5.webp", alt: "The best Classic Lasagna in addis ababa" },
    { src: "/lasagna6.webp", alt: "The best Vegan Lasagna in addis ababa" },
    { src: "/lasagna7.webp", alt: "The best Cheese Lasagna in addis ababa" },
    { src: "/lasagna8.webp", alt: "The best Lasagna Blanca in addis ababa" },
  ];
